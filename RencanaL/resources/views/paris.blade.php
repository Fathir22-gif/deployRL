            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        [
                        'name' => 'Menara Eiffel',
                        'desc' => 'Landmark ikonik Paris dengan pemandangan kota yang menakjubkan dari puncaknya.',
                        'image' => 'images/paris-gallery/eiffel.jpg'
                        ],
                        [
                        'name' => 'Museum Louvre',
                        'desc' => 'Museum seni terbesar di dunia dengan kumpulan karya seni yang luar biasa.',
                        'image' => 'images/paris-gallery/louvre.jpg'
                        ],
                        [
                        'name' => 'Arc de Triomphe',
                        'desc' => 'Monumen ikonik Paris yang menghiasi jalan besar dan memiliki sejarah yang kaya.',
                        'image' => 'images/paris-gallery/arc.jpg'
                        ],
                        [
                        'name' => 'Versailles',
                        'desc' => 'Kastil yang megah dengan taman yang indah dan sejarah yang kaya.',
