...
<head>
    ...
    <title>Daftar - RencanaLiburan</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl px-8 py-7 transition-all duration-300 hover:shadow-[0_20px_60px_-10px_rgba(56,189,248,0.35)]">
                ...
                <div class="mb-7 text-center">
                    ...
                    <p class="text-sky-100/70 text-sm mt-1">Mulai rencanakan perjalanan impianmu</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium text-sky-100 mb-1.5">Nama Lengkap</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-sky-200/70">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16 14a4 4 0 1 0-8 0M12 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-7 9a7 7 0 0 1 14 0" />
                                </svg>
                            </span>
                            <input
                                id="name"
                    ...
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-sm font-medium text-sky-100 mb-1.5">Kata Sandi</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-sky-200/70">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-sky-100 mb-1.5">Konfirmasi Kata Sandi</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-sky-200/70">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 11c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm6-2v3a6 6 0 1 1-12 0V9a6 6 0 1 1 12 0z" />
                ...
                <div class="flex items-center gap-3 my-6">
                    ...
                    <span class="text-xs text-sky-100/60">atau</span>
                    <span class="flex-1 h-px bg-white/15"></span>
                </div>

                <!-- Login Link -->
                <p class="text-center text-sm text-sky-100/80">
                    Sudah punya akun?
                    @if (Route::has('login'))
                    <a href="{{ route('login') }}" class="text-[#38BDF8] font-semibold hover:text-white transition-colors duration-200">
                        Masuk di Sini
                    </a>
                    @endif
                </p>
