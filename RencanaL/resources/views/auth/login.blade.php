...
<head>
    ...
    <title>Login - RencanaLiburan</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl px-8 py-7 transition-all duration-300 hover:shadow-[0_20px_60px_-10px_rgba(56,189,248,0.35)]">
                ...
                <div class="mb-7 text-center">
                    ...
                    <p class="text-sky-100/70 text-sm mt-1">Masuk untuk melanjutkan perjalananmu</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label for="remember" class="flex items-center gap-2 text-sky-100/90 cursor-pointer select-none">
                            <input
                                id="remember"
                                type="checkbox"
                                name="remember"
                                class="w-4 h-4 rounded border-white/30 bg-white/10 text-[#38BDF8] focus:ring-[#38BDF8] focus:ring-offset-0 cursor-pointer">
                            Ingat Saya
                        </label>

                        @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-[#38BDF8] hover:text-white transition-colors duration-200">
                            Lupa Sandi?
                        </a>
                        @endif
                    </div>
                ...
                <p class="text-center text-sm text-sky-100/80">
                    ...
                    <a href="{{ route('register') }}" class="text-[#38BDF8] font-semibold hover:text-white transition-colors duration-200">
                        Daftar Sekarang
                    </a>
                    @endif
                </p>
