            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <section>
                    ...
                    <p class="text-slate-600 leading-relaxed text-sm md:text-base">
                        Tokyo merupakan ibu kota Jepang dan salah satu kota metropolitan paling modern di dunia.
                        Kota ini menawarkan perpaduan unik antara teknologi canggih, budaya tradisional,
                        kuliner kelas dunia, serta kehidupan perkotaan yang dinamis. Wisatawan dapat menikmati
                        ikon terkenal seperti Tokyo Tower, Shibuya Crossing, dan Kuil Senso-ji, sekaligus
                        merasakan suasana khas Jepang melalui taman sakura, festival budaya, dan pusat perbelanjaan modern.
                        Tokyo menjadi destinasi favorit bagi pecinta teknologi, budaya pop Jepang, kuliner, maupun wisata keluarga.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        'desc' => 'Menara pemancar tertinggi di dunia dengan dek observasi futuristik dan kompleks belanja raksasa.',
            ...
            <aside class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-24">
                    ...
                    <form action="{{ route('wishlist.add') }}" method="POST">
                        ...
                        <input type="hidden" name="name" value="Tokyo">
                        <input type="hidden" name="country" value="Jepang">
                        <input type="hidden" name="rating" value="4.9">
                        <input type="hidden" name="budget" value="Rp 22.000.000">
                        <input type="hidden" name="description" value="Perpaduan budaya tradisional dan teknologi modern">
                        <input type="hidden" name="route" value="tokyo">
