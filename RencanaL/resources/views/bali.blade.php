            ...
            <aside class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-24">
                    ...
                    <form action="{{ route('wishlist.add') }}" method="POST">
                        ...
                        <input type="hidden" name="name" value="Bali">
                        <input type="hidden" name="country" value="Indonesia">
                        <input type="hidden" name="rating" value="4.8">
                        <input type="hidden" name="budget" value="Rp 3.500.000">
                        <input type="hidden" name="description" value="Pulau Dewata dengan pantai dan budaya yang indah">
                        <input type="hidden" name="route" value="bali">
